...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Climb lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == climbLottery, "Only ClimbLottery");
    ...
    /**
     * @notice Set the address for the ClimbLottery
     * @param _climbLottery: address of the Climb lottery
     */
    function setLotteryAddress(address _climbLottery) external onlyOwner {
        climbLottery = _climbLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IClimbLottery(climbLottery).viewCurrentLotteryId();
    }
}